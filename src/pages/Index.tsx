...
import { ArrowRight, BarChart, Brain, MusicIcon, Smile, Sparkles, Users } from "lucide-react";
      ...
      <section className="py-16 bg-mhm-blue-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold font-serif mb-4">How MindMirror Helps</h2>
      ...
      <footer className="bg-mhm-blue-50 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 pt-6 border-t border-muted text-center text-sm text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} MindMirror. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </Layout>
